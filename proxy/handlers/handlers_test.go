...
func TestProxyJson(t *testing.T) {
	...
	destinationClient := forwardrpc.NewMockForward_SendMetricsV2Client(ctrl)
	fixture.Destinations.EXPECT().
		Get("metric-namecountertag1:value1,tag2:value2").DoAndReturn(
		func(string) (*destinations.Destination, error) {
			return &destinations.Destination{
				Client: destinationClient,
			}, nil
		})
	destinationClient.EXPECT().Send(&metricpb.Metric{
		Name: "metric-name",
...
func TestProxyGrpcSingle(t *testing.T) {
	...
	destinationClient.EXPECT().Send(metric)
...
func TestProxyGrpcStreamIgnoreTags(t *testing.T) {
	...
	destinationClient := forwardrpc.NewMockForward_SendMetricsV2Client(ctrl)
	fixture.Destinations.EXPECT().
		Get("metric-namecountertag2:value2").DoAndReturn(
		func(string) (*destinations.Destination, error) {
			return &destinations.Destination{
				Client: destinationClient,
			}, nil
